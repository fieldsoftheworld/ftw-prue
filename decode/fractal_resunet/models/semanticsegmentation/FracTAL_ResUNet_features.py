            ...
            if upFuse:
                self.UpCombs.append(
                    combine_layers_wthFusion(
                        nfilters=nfilters, nheads=nheads, norm_type=norm_type, norm_groups=norm_groups, ftdepth=ftdepth
                    )
                )
            else:
                self.UpCombs.append(combine_layers(nfilters, norm_type=norm_type, norm_groups=norm_groups))
