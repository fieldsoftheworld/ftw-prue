...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--coco-root", required=True, help="Root directory of the COCO dataset for metadata and images."
    )
    parser.add_argument(
        "--opts",
        default=[],
        nargs=argparse.REMAINDER,
        help="Additional config options to override, e.g., DATASETS.COUNTRIES_EVAL 'austria,belgium' TEST.EVAL_SUBSET_SIZE 200",
    )
