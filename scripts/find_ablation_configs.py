...
def main():
    parser = argparse.ArgumentParser(
        description="Find all YAML config files in an ablations directory"
    )
    parser.add_argument(
        "ablations_dir",
        type=str,
        help="Path to the ablations directory (relative to project root or absolute)"
    )
    parser.add_argument(
        "--recursive",
        action="store_true",
    ...
    parser.add_argument(
        ...
        dest="recursive",
        action="store_false",
        help="Only search top-level directory"
    )
    parser.add_argument(
        "--format",
