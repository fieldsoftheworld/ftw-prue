...
if __name__ == "__main__":
    ...
    temporal_options = "windowB" #'Temporal option (stacked, windowA, windowB, etc.)'
    batch_size = 8 #64
    ...
    ## setup SAM model
    ckpt_path = "/projects/benq/atwollam/FTW-Bakeoff/specialized_field_models/sam/checkpoints/sam_winB_decoder_only_1_3000" #sam_vit_h_4b8939.pth"
    ...
    predictor.model.prompt_encoder.train(False) # enable training of prompt encoder
        ...
        with tqdm(dl, unit='batch') as tdl:
            for itr, batch in enumerate(tdl):
                with torch.cuda.amp.autocast():
                    ...
                    if itr%1000==0: torch.save(predictor.model.state_dict(), "checkpoints/sam_{}_{}_{}".format(exp_name,epoch,itr)) # save model
