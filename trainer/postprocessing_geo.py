...
def filter_by_cropland_mask(
    polygons_gdf: gpd.GeoDataFrame, cropland_mask_path: str, overlap_fraction: float = 0.5, check_bounds: bool = True
) -> gpd.GeoDataFrame:
    """
...
def resolve_overlaps(
    polygons_gdf: gpd.GeoDataFrame, overlap_threshold: float = 0.3, keep_higher_confidence: bool = True
) -> gpd.GeoDataFrame:
    """
...
def filter_edge_polygons_geo(
    polygons_gdf: gpd.GeoDataFrame, chip_bounds: box, edge_buffer: float = 50.0
) -> gpd.GeoDataFrame:
    """
...
def merge_overlapping_fields(polygons_gdf: gpd.GeoDataFrame, iou_threshold: float = 0.7) -> gpd.GeoDataFrame:
    """
