    ...
    def __init__(self, metadata, instance_mode=ColorMode.IMAGE):
        ...
        if missing_fields:
            ...
            if "stuff_colors" in missing_fields:
                self.metadata.stuff_colors = [random_color(rgb=True, maximum=255) for _ in self.metadata.stuff_classes]
            if "stuff_dataset_id_to_contiguous_id" in missing_fields:
                self.metadata.stuff_dataset_id_to_contiguous_id = self.metadata.thing_dataset_id_to_contiguous_id
